...
fudge_axis <- tibble(d = c(0,1), q = c(0.001,1))
f_consang <- consang %>% 
  ...
  theme_cb_zoom + geom_rangeframe(data = fudge_axis) + scale_y_continuous(breaks = seq(0, 1, 0.1))
f_consang
save_plot(f_consang, filename = "f_consang.pdf", base_height = 5, base_asp = 2)

# parent model
fudge_axis <- tibble(q = c(0,1), cb_parent = c(-2,2))
f_parent <- consang %>% 
  ...
  theme_cb + geom_rangeframe(data = fudge_axis) + scale_x_continuous(breaks = seq(0, 1, 0.2)) + 
  geom_ribbon(aes(ymin = -1, ymax = 1), alpha=0.25)
f_parent

fudge_axis <- tibble(q = c(0,1), cb_parent = c(0,0.05))
f_parent_zoom <- ggplot(consang, aes(x = q, y = cb_parent)) + geom_line() +
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_parent_zoom
save_plot(f_parent_zoom, filename = "f_parent_zoom.pdf", base_height = 5, base_asp = 2)

# actor dispersing
fudge_axis <- tibble(q = c(0,1), cb_actdis = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actdis = c(0,0.04))
f_actdis_zoom <- ggplot(consang, aes(x = q, y = cb_actdis)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actdis_zoom
save_plot(f_actdis_zoom, filename = "f_actdis_zoom.pdf", base_height = 5, base_asp = 2)

# actor sedentary
fudge_axis <- tibble(q = c(0,1), cb_actsed = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actsed = c(0,0.06))
f_actsed_zoom <- ggplot(consang, aes(x = q, y = cb_actsed)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actsed_zoom
save_plot(f_actsed_zoom, filename = "f_actsed_zoom.pdf", base_height = 5, base_asp = 2)

# actor dispersing, recipient dispersing
fudge_axis <- tibble(q = c(0,1), cb_actdis_recdis = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actdis_recdis = c(0,0.5))
f_actdis_recdis_zoom <- ggplot(consang, aes(x = q, y = cb_actdis_recdis)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actdis_recdis_zoom
save_plot(f_actdis_recdis_zoom, filename = "f_actdis_recdis_zoom.pdf", base_height = 5, base_asp = 2)

# actor dispersing, recipient sedentary
fudge_axis <- tibble(q = c(0,1), cb_actdis_recsed = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actdis_recsed = c(0,0.02))
f_actdis_recsed_zoom <- ggplot(consang, aes(x = q, y = cb_actdis_recsed)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actdis_recsed_zoom
save_plot(f_actdis_recsed_zoom, filename = "f_actdis_recsed_zoom.pdf", base_height = 5, base_asp = 2)

# actor sedentary, recipient dispersing
fudge_axis <- tibble(q = c(0,1), cb_actsed_recdis = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actsed_recdis = c(0,10))
...
save_plot(f_actsed_recdis_zoom, filename = "f_actsed_recdis_zoom.pdf", base_height = 5, base_asp = 2)

# actor sedentary, recipient sedentary
fudge_axis <- tibble(q = c(0,1), cb_actsed_recsed = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actsed_recsed = c(0,0.03))
...
save_plot(f_actsed_recsed_zoom, filename = "f_actsed_recsed_zoom.pdf", base_height = 5, base_asp = 2)

# actor dispersing, recipient dispersing, Q = 1
fudge_axis <- tibble(q = c(0,1), cb_actdis_recdis_1 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actdis_recdis_1 = c(0.45,0.55))
f_actdis_recdis_1_zoom <- ggplot(consang, aes(x = q, y = cb_actdis_recdis_1)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actdis_recdis_1_zoom
save_plot(f_actdis_recdis_1_zoom, filename = "f_actdis_recdis_1_zoom.pdf", base_height = 5, base_asp = 2)

# actor dispersing, recipient dispersing, Q = 0
fudge_axis <- tibble(q = c(0,1), cb_actdis_recdis_0 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actdis_recdis_0 = c(-0.05,0.05))
f_actdis_recdis_0_zoom <- ggplot(consang, aes(x = q, y = cb_actdis_recdis_0)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actdis_recdis_0_zoom
save_plot(f_actdis_recdis_0_zoom, filename = "f_actdis_recdis_0_zoom.pdf", base_height = 5, base_asp = 2)

# actor dispersing, recipient sedentary, Q = 1
fudge_axis <- tibble(q = c(0,1), cb_actdis_recsed_1 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actdis_recsed_1 = c(0,0.5))
f_actdis_recsed_1_zoom <- ggplot(consang, aes(x = q, y = cb_actdis_recsed_1)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actdis_recsed_1_zoom
save_plot(f_actdis_recsed_1_zoom, filename = "f_actdis_recsed_1_zoom.pdf", base_height = 5, base_asp = 2)

# actor dispersing, recipient sedentary, Q = 0
fudge_axis <- tibble(q = c(0,1), cb_actdis_recsed_0 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actdis_recsed_0 = c(0,-0.5))
f_actdis_recsed_0_zoom <- ggplot(consang, aes(x = q, y = cb_actdis_recsed_0)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actdis_recsed_0_zoom
save_plot(f_actdis_recsed_0_zoom, filename = "f_actdis_recsed_0_zoom.pdf", base_height = 5, base_asp = 2)

# actor sedentary, recipient dispersing, Q = 1
fudge_axis <- tibble(q = c(0,1), cb_actsed_recdis_1 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actsed_recdis_1 = c(0,10))
...
save_plot(f_actsed_recdis_1_zoom, filename = "f_actsed_recdis_1_zoom.pdf", base_height = 5, base_asp = 2)

# actor sedentary, recipient dispersing, Q = 0
fudge_axis <- tibble(q = c(0,1), cb_actsed_recdis_0 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actsed_recdis_0 = c(-0.05,0.05))
f_actsed_recdis_0_zoom <- ggplot(consang, aes(x = q, y = cb_actsed_recdis_0)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actsed_recdis_0_zoom
save_plot(f_actsed_recdis_0_zoom, filename = "f_actsed_recdis_0_zoom.pdf", base_height = 5, base_asp = 2)

# actor sedentary, recipient sedentary, Q = 1
fudge_axis <- tibble(q = c(0,1), cb_actsed_recsed_1 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actsed_recsed_1 = c(0.45,0.55))
f_actsed_recsed_1_zoom <- ggplot(consang, aes(x = q, y = cb_actsed_recsed_1)) + geom_line() +  
  labs(x = expression(paste("Neighborhood consanguinity (", italic("q"), ")")), 
       y = expression(paste("Evolutionarily stable ", italic("C/B")))) + 
  theme_cb_zoom + scale_x_continuous(breaks = seq(0, 1, 0.1)) + geom_rangeframe(data = fudge_axis)
f_actsed_recsed_1_zoom
save_plot(f_actsed_recsed_1_zoom, filename = "f_actsed_recsed_1_zoom.pdf", base_height = 5, base_asp = 2)

# actor sedentary, recipient sedentary, Q = 0
fudge_axis <- tibble(q = c(0,1), cb_actsed_recsed_0 = c(-2,2))
...
fudge_axis <- tibble(q = c(0,1), cb_actsed_recsed_0 = c(0,-10))
...
save_plot(f_actsed_recsed_0_zoom, filename = "f_actsed_recsed_0_zoom.pdf", base_height = 5, base_asp = 2)
...
save_plot(cb_scaled, filename = "cb_scaled.pdf", base_width = 8.5, base_height = 8)